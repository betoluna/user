 ...
 * Methods used: recursive, and coherence. Please set the boolean 'useCoherence' accordingly.
 */
...
public class Circle_Flood implements PlugInFilter {
    ...
    private boolean useCoherence = false;
    ...
    public void run(ImageProcessor ip) {
        ...
        new ImagePlus("Circular_Hough " + using, edgeImProc).show();
    ...
    */
    public void recursiveFloodFill(ImageProcessor proc, int CX, int CY, int R, int u, int v, int label) {   
        ...
        if (proc.getPixel(u, v) == 255 || d > R) return;       
